...
namespace eshop_srytr.Areas.Admin.Controllers
{
    ...
    {
        private readonly EshopDatabase _context;

        public OrderItemsController(EshopDatabase context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.ProductItems, "ID", "ImageSource");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,OrderID,ProductID,Amount,Price")] OrderItem orderItem)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.ProductItems, "ID", "ImageSource", orderItem.ProductID);
            return View(orderItem);
        }
